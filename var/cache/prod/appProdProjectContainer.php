...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.facebook_authenticator' => 'getApp_FacebookAuthenticatorService',
            'app.facebook_provider' => 'getApp_FacebookProviderService',
            'app.google_authenticator' => 'getApp_GoogleAuthenticatorService',
            'app.google_provider' => 'getApp_GoogleProviderService',
    ...
    /*
     * Gets the 'app.facebook_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\FacebookAuthenticator A AppBundle\Security\FacebookAuthenticator instance
     */
    protected function getApp_FacebookAuthenticatorService()
    {
        return $this->services['app.facebook_authenticator'] = new \AppBundle\Security\FacebookAuthenticator($this);
    }

    /*
     * Gets the 'app.facebook_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \League\OAuth2\Client\Provider\Facebook A League\OAuth2\Client\Provider\Facebook instance
     */
    protected function getApp_FacebookProviderService()
    {
        return $this->services['app.facebook_provider'] = new \League\OAuth2\Client\Provider\Facebook(array('clientId' => 1841494202832876, 'clientSecret' => '8e4f4ed400ebe6bb4b6a8df7e36a20bb', 'graphApiVersion' => 'v2.3', 'redirectUri' => 'https://myjobsadvisor.com/connect/facebook-check'));
    }

    /*
     * Gets the 'app.google_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\GoogleAuthenticator A AppBundle\Security\GoogleAuthenticator instance
     */
    protected function getApp_GoogleAuthenticatorService()
    {
        return $this->services['app.google_authenticator'] = new \AppBundle\Security\GoogleAuthenticator($this);
    }

    /*
     * Gets the 'app.google_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \League\OAuth2\Client\Provider\Google A League\OAuth2\Client\Provider\Google instance
     */
    protected function getApp_GoogleProviderService()
    {
        return $this->services['app.google_provider'] = new \League\OAuth2\Client\Provider\Google(array('clientId' => '43785180861-hmi257jor14qp192g1ei0l63tuens5gt.apps.googleusercontent.com', 'clientSecret' => 'BQlu4FyhQT_DFkRn8ByqsANM', 'redirectUri' => 'https://myjobsadvisor.com/connect/google-check'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('diYcbcPVMX', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fGnF27Wp5-', 0, 'DKQ6DkEWU4z+VJXGq9kiie', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TUUvHqpye8', 0, 'DKQ6DkEWU4z+VJXGq9kiie', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'myjobsa1_myjobsadvisor', 'user' => 'myjobsa1_admin', 'password' => 'adminmyjobs123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dc29d426c00b189e20196aaa49b532a465a437763d211a3576d4a4df5b181f23');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Controller\LogoutSuccessHandler A AppBundle\Controller\LogoutSuccessHandler instance
     */
    protected function getLogoutSuccessHandlerService()
    {
        return $this->services['logout_success_handler'] = new \AppBundle\Controller\LogoutSuccessHandler($this->get('security.http_utils'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false)), 'BackendBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 4))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $i->setOptions(array('login_path' => '/admin/login', 'default_target_path' => '/admin/panel', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('security.user.provider.concrete.user_db_provider')), 'admin', $b, $c, $d), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'admin', $i, $j, array('check_path' => '/admin/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a888d8fdbb326.25866402', $b, $g), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/admin/login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h->setOptions(array('login_path' => '/loginerror', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $h->setProviderKey('main');

        $i = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $e, array(), $b);
        $i->setOptions(array('login_path' => '/loginerror', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('security.user.provider.concrete.user_db_provider')), 'main', $b, $c, $d), 2 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, $this->get('logout_success_handler'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout')), 3 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $f, 'main', array(0 => $this->get('app.facebook_authenticator'), 1 => $this->get('app.google_authenticator')), $b), 4 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $e, 'main', $h, $i, array('check_path' => '/login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5a888d8fdbb326.25866402', $b, $f), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $d, $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $e, '/loginerror', false), NULL, NULL, $b, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('_mainaccount@myjobsadvisor.com');
        $a->setPassword('iO82w9nXj4');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('vm13.digitalserver.org');
        $instance->setPort(25);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\FollowingExtension($a));
        $instance->addExtension(new \AppBundle\Twig\LongTimeExtension());
        $instance->addExtension(new \AppBundle\Twig\UserStatsExtension($a));
        $instance->addExtension(new \AppBundle\Twig\LikedExtension($a));
        $instance->addExtension(new \AppBundle\Twig\CompanyStatsExtension($a));
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T6VXC09Q39', 0, 'DKQ6DkEWU4z+VJXGq9kiie', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/panel'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/createcomment'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/createcommentuser'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/empresas/registrar'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/empresa/editar'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/opinion/remove'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/comment/remove'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/follow'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/unfollow'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/siguiendo'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/seguidores'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/likes'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/logout'), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/usuarios'), array(0 => 'ROLE_USER'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.user_db_provider');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), $a, 'admin', $b, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a888d8fdbb326.25866402'), 2 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('app.facebook_authenticator'), 1 => $this->get('app.google_authenticator')), $c, 'main', $a), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($c, $a, 'main', $b, true), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a888d8fdbb326.25866402')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'myjobsa1_myjobsadvisor',
            'database_user' => 'myjobsa1_admin',
            'database_password' => 'adminmyjobs123',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'vm13.digitalserver.org',
            'mailer_user' => '_mainaccount@myjobsadvisor.com',
            'mailer_password' => 'iO82w9nXj4',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'facebook_app_id' => 1841494202832876,
            'facebook_app_secret' => '8e4f4ed400ebe6bb4b6a8df7e36a20bb',
            'google_app_id' => '43785180861-hmi257jor14qp192g1ei0l63tuens5gt.apps.googleusercontent.com',
            'google_app_secret' => 'BQlu4FyhQT_DFkRn8ByqsANM',
            'locale' => 'en',
            ...
            'validator.mapping.cache.prefix' => 'validator_7beb0e841076c4a512b2a4c667f563c8aca569d0d8bcb297794dc90fc4b389b9',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'vm13.digitalserver.org',
            'swiftmailer.mailer.default.transport.smtp.username' => '_mainaccount@myjobsadvisor.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'iO82w9nXj4',
