 ...
 */
class Localidad extends \BackendBundle\Entity\Localidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\Localidad' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\Localidad' . "\0" . 'municipioId', '' . "\0" . 'BackendBundle\\Entity\\Localidad' . "\0" . 'clave', '' . "\0" . 'BackendBundle\\Entity\\Localidad' . "\0" . 'nombre', '' . "\0" . 'BackendBundle\\Entity\\Localidad' . "\0" . 'activo'];
        }
